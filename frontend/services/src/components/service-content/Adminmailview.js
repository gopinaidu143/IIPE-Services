...
//     try {
//       const response = await axios.get("/api/email-requisition-list/");
//       setEmailRequests(response.data);
//       setLoading(false);
//     } catch (err) {
//       setError("Failed to fetch email requests. Please try again.");
//       setLoading(false);
//     }
//   };
...
//     try {
//       await axios.post(`/api/email-requisition/${selectedRequest.id}/response/`, {
//         message: messageBody
//       });
//       setShowModal(false);
//       setMessageBody("");
...
//     try {
//       await axios.post(`/api/email-requisition/${id}/resolve/`);
...
//   const currentItems = emailRequests.slice(indexOfFirstItem, indexOfLastItem);

//   const paginate = (pageNumber) => setCurrentPage(pageNumber);

//   if (loading) return <p style={styles.loadingText}>Loading email requests...</p>;
//   if (error) return <p style={styles.errorText}>{error}</p>;

//   return (
//     <div style={styles.container}>
//       <h2 style={styles.title}>Email Requisition Requests</h2>
//       <div style={styles.tableCard}>
//         <div style={styles.tableHeader}>
//           <div style={styles.headerCell}>Name</div>
//           <div style={styles.headerCell}>Program</div>
//           <div style={styles.headerCell}>Department</div>
//           <div style={styles.headerCell}>Personal Email</div>
//           <div style={styles.headerCell}>Contact No</div>
...
//               <div style={styles.cell}>{request.program}</div>
//               <div style={styles.cell}>{request.department}</div>
//               <div style={styles.cell}>{request.person_email}</div>
//               <div style={styles.cell}>{request.contact_no}</div>
...
//           </svg>
//         </button>
//         {Array.from({ length: Math.ceil(emailRequests.length / itemsPerPage) }, (_, i) => (
//           <button
//             key={i}
...
//         <button
//           onClick={() => paginate(currentPage + 1)}
//           disabled={currentPage === Math.ceil(emailRequests.length / itemsPerPage)}
//           style={styles.paginationArrow}
//         >
//           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={styles.arrowIcon}>
