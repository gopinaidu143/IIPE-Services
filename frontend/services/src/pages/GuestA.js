...
// import GuestA from '../assets/GuestA.jpg';
...
function GuestHousePage() {
  ...
  const content = {
    overview: (
      <>
        <h3 style={styles.aboutTitle}>ABOUT: Guest House A</h3>
        <p>
    ...
    facilities: (
      <>
        <h3 style={styles.aboutTitle}>FACILITIES at Guest House A</h3>
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.titleContainer}>
        <h1 style={styles.title}>GUEST HOUSE A</h1>
      </div>
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.infoCard}>   
          <h2 style={{ fontSize: '18px', fontWeight: 'bold' }}>GUEST HOUSE A</h2>
