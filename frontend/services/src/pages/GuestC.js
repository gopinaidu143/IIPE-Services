...
// Sample images array
const images = [
  require('../assets/GuestC.jpg'),  // Ensure all image paths are correct
  require('../assets/GuestA.jpg'),
  require('../assets/GuestB.jpg'),
];

function GuestHousePageC() {
  ...
  const content = {
    overview: (
      <>
        <h3 style={styles.aboutTitle}>ABOUT: Guest House C</h3>
        <p>
    ...
    facilities: (
      <>
        <h3 style={styles.aboutTitle}>FACILITIES at Guest House C</h3>
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.titleContainer}>
        <h1 style={styles.title}>GUEST HOUSE C</h1>
      </div>
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.infoCard}>   
          <h2 style={{ fontSize: '18px', fontWeight: 'bold' }}>GUEST HOUSE C</h2>
...
export default GuestHousePageC;
